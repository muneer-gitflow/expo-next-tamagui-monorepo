...
import { DeviceStatusBar } from '../simulator/device-status-bar';
import { DeviceFrame } from '../simulator/device-frame';
import { DeviceScreen } from '../simulator/device-screen';

export default function NavigationMobileSimulator() {
