...
export default function IosDeviceFrame({ children }: IosDeviceFrameProps) {
  return (
    <Box
      ...
      overflowY="hidden"
    >
      <div className="simulatorScreenCenterFix">
        <div className="simulatorScreenOuter">
          <DeviceHeader />
...
function DeviceHeader() {
  return (
    <div className="deviceHead">
      <span className="deviceHead__time">9:41</span>
      <img src="/notch.png" className="deviceHead__notch" alt="notch" />
      <span className="deviceHead__statusIcons">
        <SignalIcon />
        <WifiIcon />
        <BatteryIcon />
      </span>
...
function DeviceFrame() {
  return <img src="/mobileSimulator.png" className="deviceFrame" alt="mobile simulator" />;
}
