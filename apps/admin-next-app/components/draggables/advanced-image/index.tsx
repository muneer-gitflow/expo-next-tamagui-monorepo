...
import type { VendorBlock as StoreVendorBlock } from 'app/lib/store/types';
...
export default function BannerImageEditor() {
  ...
  const vendorBlocks: StoreVendorBlock[] = useSelector((state: RootState) => state.vendorBlocks.blocks);
  // current block id
