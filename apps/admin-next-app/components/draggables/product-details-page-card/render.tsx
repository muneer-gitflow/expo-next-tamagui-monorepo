import { Badge, DescriptionList, InlineGrid, InlineStack } from '@shopify/polaris';

export default function ProductDetailsPageCardRender({ blockId }: { blockId: string }) {
  return (
    <>
      <InlineGrid gap={'400'}>
        <span
        ...
        >
          ...
          contemporary comfort. Crafted with meticulous attention to detail, this shirt is designed to make a statement
          in any setting.{' '}
          <span
            style={{
              color: '#528F65',
