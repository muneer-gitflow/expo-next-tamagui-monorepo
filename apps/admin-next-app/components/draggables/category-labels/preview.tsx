import { InlineGrid, Box, Text } from '@shopify/polaris';
import type { UIBlock } from '@/lib/store/types';

interface CategoryLabelsPreviewProps {
  blockId: string;
  block: UIBlock;
}

export default function CategoryLabelsPreview({ blockId, block }: CategoryLabelsPreviewProps) {
  return (
    <>
